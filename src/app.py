...
# first row 
    ...
    dbc.Row([
        ...
        # column with card 1_1 #iMMAP 
        dbc.Col([
            dbc.Card([
                dbc.CardImg(src='/assets/iMMAP_moz.png', style={'height':'100%','width':'100%'}, className = 'align-self-center'),
                            dbc.CardLink("MozDataScience catalog", target="_blank", href=""),#https://immapmoz.org/catalog/
...
dbc.Row(dbc.Col(html.Hr(style={'borderWidth': "0.4vh", "width": "100%", "borderColor": "#6d6e71", "borderStyle":"double"}), className="mb-0", width={'size':12, 'offset':0}),),
    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardLink("www.MozDataScience.org ", target="_blank", href=""),#https://www.immap.org
        ...
        dbc.Col([
            ...
            dbc.CardLink("rep-mozambique@MOzDataScience.org", target="_blank", href=""),#rep-mozambique@immap.org
            ],style={'height':'100%','width':'100%', "float": "center", "textAlign": "left"}, className = "mb-0 border-0 bg-transparent"),
